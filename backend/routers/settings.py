...
Return ONLY a raw valid JSON object (no markdown code blocks, no preambles, no conversational commentary) matching this exact schema:
{
  ...
  "jobspy_search_term": "<Comma separated list of 3-6 job titles e.g. DevOps Engineer, Cybersecurity Lead, ML Engineer>",
  "extraction_keywords": ["<Keyword 1>", "<Keyword 2>", "<Keyword 3>", "<Keyword 4>", "<Keyword 5>"],
  "social_triggers": ["<Trigger 1>", "<Trigger 2>", "<Trigger 3>"],
  "social_topics": ["<Topic 1>", "<Topic 2>"],
  "news_queries": [
...
"""
    ...
    return {
        ...
        "jobspy_search_term": "DevOps Engineer, Cybersecurity Manager, ML Engineer, VP of Engineering",
        "extraction_keywords": ["DevOps hiring", "cybersecurity staffing", "ML talent acquisition", "recruitment agency", "fractional CTO"],
        "social_triggers": ["hiring", "looking for", "need a", "recommend"],
        "social_topics": ["recruitment agency", "tech staffing"],
        "news_queries": [
            "(\"expanding tech team\" OR \"hiring DevOps\" OR \"scaling engineering\") AND (\"USA\")",
            "(\"raised funding\" OR \"Series A\" OR \"Seed\") AND (\"staffing\" OR \"cybersecurity\")"
        ],
        "serper_queries": [
            "site:linkedin.com/posts (\"looking for a recruitment agency\" OR \"recommend a tech recruiter\") -clutch",
            "site:linkedin.com/posts (\"hiring DevOps engineers\" OR \"need cybersecurity talent\")"
        ],
        "summary_explanation": "Configured ICP targeting US Tech & Recruitment (DevOps, Cybersecurity, ML roles) for 50-2000 employee headcount."
    }
