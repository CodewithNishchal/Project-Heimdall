...
async def main():
    ...
    # We test both possible LinkedIn URLs for Karini AI
    test_urls = [
        "https://www.linkedin.com/company/karini-ai/",
        "https://www.linkedin.com/company/karini/"
    ]
            ...
            try:
                ...
                if resp.status_code in [200, 201]:
                    ...
                    if isinstance(data, list) and len(data) > 0:
                        ...
                        print(f"     median_tenure: {item.get('median_tenure')}")
                        print(f"     average_tenure: {item.get('average_tenure')}")
                        print("\nFull Insights Object Keys:", list(item.keys()))
